...
def search_overseer_thread(args, user_locations, pause_bit, encryption_lib_path, db_updates_queue, wh_queue):
...
def search_overseer_thread_ss(args, user_locations, pause_bit, encryption_lib_path, db_updates_queue, wh_queue):
